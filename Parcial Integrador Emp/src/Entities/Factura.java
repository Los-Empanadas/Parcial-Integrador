...
public class Factura extends Base{
    ...
    public Factura(Long id,LocalDate fechaFacturacion, Integer mpPaymentId, Integer mpMerchantOrderId, String mpPreferenceId, String mpPaymentType, FormaPago formaPago, Double totalVenta, Pedido pedido) {
        super();
